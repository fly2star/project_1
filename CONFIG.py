...
parser.add_argument("--alpha",type=float,default=1.0,help="weight of origial dech loss")                    # 0.9
parser.add_argument("--beta",type=float,default=0.5,help="weight of fuzzy multimodal loss")                 # 0.9
parser.add_argument("--gamma",type=float,default=0.1,help="weight of consistency learning loss")            # 0.1
parser.add_argument('--delta', type=float, default=0.01,help="Weight for the quanzation loss")               # 0.1
parser.add_argument('--eta', type=float, default=0.5,help="Weight for the vib loss")                        # 0.5
parser.add_argument('--theta', type=float, default=0.01, help='protottype loss')                            # 0.5
